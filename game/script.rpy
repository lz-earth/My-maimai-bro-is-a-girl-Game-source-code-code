...
label start:
    ...
    mc "在她们眼里，舞萌只有'术力口'和'其他'两个分类哦。"

    mc "其他的歌里面，不管是潘多拉还是茄子，都入不了她们的法眼呢。"

    mc "如果你执意选取那些难听的曲目，和她们拼机的时候，可是会被她们用白眼鄙视的哟～"

    mc "所以呀，我一直坚持一个原则：只要对面是女生，就绝对不会和她们拼机！最好是有多远就躲多远，千万别让她们来烦我～"
