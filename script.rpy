...
# ==============================================================================
# 周哲 - 阴暗废宅男
image zhouzhe neutral = "zhouzhe_neutral.png"
image zhouzhe angry = "zhouzhe_angry.png"
image zhouzhe pain = "zhouzhe_pain.png"
image zhouzhe proud = "zhouzhe_proud.png"
image zhouzhe tired = "zhouzhe_tired.png"
image zhouzhe happy = "zhouzhe_happy.png"

# 莫莫 - 可爱后辈（实际是女生）
image momo cheerful = "momo_cheerful.png"
image momo proud = "momo_proud.png"
image momo sad = "momo_sad.png"
image momo crying = "momo_crying.png"
image momo surprised = "momo_surprised.png"
image momo teasing = "momo_teasing.png"

# 阿煌
image ahuang = "ahuang.png"

# ==============================================================================
# 背景定义
# ==============================================================================
# 场景背景（使用占位符，实际使用时替换为具体图片）
# 格式：bg_[场景名]_[时间]
# 01 - QQ群聊
# 02 - 周哲房间
# 03 - 机厅门口
...
label start:
    ...
    # ===== 场景1：QQ群聊 =====
    scene bg_qq_group_day with fade

    play music bgm_group_chat fadein 1.0

    narrator "舞萌舞萌DX玩家群"

    show zhouzhe neutral at left

    mc "作为一个舞萌老玩家，我可以很负责任的告诉你，女性玩家和男性玩家是两个完全不同的群体。"

    mc "女生是一群穿着奇怪的cos服、只会选术力口曲、成天和男朋友腻歪在一起的生物。"

    mc "在她们眼里，舞萌只有'术力口'和'其他'两个分类。"

    mc "其他的歌里面，不管是潘多拉还是茄子，都入不了她们的法眼。"

    mc "如果你执意选取那些难听的曲目，和她们拼机的时候，你将会遭受她们白眼的鄙视。"

    mc "所以，我一直坚持一个原则：只要对面是女生，就绝不会和她们拼机！最好是有多远就躲多远，千万别让她们烦我！"
    ...
    hide zhouzhe neutral
    show zhouzhe angry at left
    ...
    hide ahuang
    hide zhouzhe pain
    show zhouzhe neutral at center
    ...
    # ===== 显示成绩图CG =====
    show cg_score_tiamat at center with dissolve

    pause 2.0

    hide cg_score_tiamat with dissolve

    narrator "提亚马特，100.15%"

    show momo cheerful at right

    momo "前辈前辈，看到了吗，我把提亚马特鸟了！嘿嘿！"

    momo "前辈是不是没我高啊，要不要我来教你！"
...
label chapter2:
    ...
    # ===== 场景：机厅门口 =====
    scene bg_arcade_entrance with fade
    ...
    # ===== 场景：发现莫莫 =====
    scene bg_arcade_maimai with fade
    ...
    show zhouzhe pain at left with hpunch
    ...
    mc "诶，真的得加强体质训练了。要不然，迟早会被这家伙给撞成残疾人。"
    ...
    # ===== 显示Rating CG =====
    show cg_rating_15750 at center with dissolve

    pause 2.0

    hide cg_rating_15750 with dissolve

    show zhouzhe surprised at left
...
label chapter3:
    ...
    # ===== 显示莫莫成绩CG =====
    show cg_score_98 at center with dissolve

    narrator "果不其然，只有98.3504%，S+！"

    hide cg_score_98 with dissolve
...
label chapter4:
    ...
    # ===== 选歌CG =====
    show cg_song_amazing at center with dissolve

    narrator "AMAZING MIGHTYYYY ，expert 13难度。"

    hide cg_song_amazing with dissolve

    show zhouzhe happy at left
    ...
    show zhouzhe angry at left with hpunch
    ...
    narrator "他发誓自从自己打舞萌以来，遇到的奇葩简直数不胜数，可像莫莫这么奇葩的，还真是第一次碰见！"
    ...
    # ===== 紫14+ CG =====
    show cg_purple_14 at center with dissolve
    ...
    hide cg_purple_14 with dissolve
    ...
    # ===== 开始挑战 =====
    show zhouzhe determined at left
    ...
    # ===== 尾声 =====
    scene bg_hospital_room with fade
    ...
    narrator "映入眼帘的，是医院洁白的天花板。"

    narrator "而在他的床边，一个熟悉的身影正趴在床沿，睡得正香。"

    show zhouzhe neutral at left

    narrator "是莫莫。"

    narrator "近距离看去，周哲突然发现了一些以前从未注意到的细节。"

    narrator "莫莫的睫毛很长，批下来的头发也柔软得让人心动。"

    narrator "那张脸庞，是如此清秀可人……"
    ...
    show momo sleeping at right with dissolve

    narrator "就在这时，莫莫似乎感受到了什么，慢慢睁开了眼睛。"
    ...
    label ending_reveal:
        ...
        momo "我只是……只是想和前辈一起打舞萌嘛……"

        momo "因为前辈很厉害啊！我很崇拜前辈的！"
        ...
        momo "不过前辈，你也没有问过我是不是男孩子呀~"

        momo "是你自己一直以为我是男孩子的嘛~"
        ...
        # ===== 结局CG =====
        show cg_happy_ending at center with dissolve

        narrator "就这样，周哲和莫莫——不对，苏小晴的故事，还在继续。"

        narrator "在这个充满音乐和汗水的机厅里，"

        narrator "他们的羁绊，正在慢慢加深……"

        hide cg_happy_ending with dissolve

    # ===== 结局 =====
    scene black with fade

    centered "{size=+20}—— 结局 ——{/size}"
    centered "{size=+5}《一起玩音游的后辈，居然是女生》{/size}"

    pause 2.0

    centered "{size=+5}THE END{/size}"

    centered "{size=+3}感谢游玩！{/size}"
...
screen qq_notification:
    text "{size=+5}【QQ消息】莫莫发来一张图片{/size}" at (0.5, 0.1) with d5
    text "{size=-2}点击继续...{/size}" at (0.5, 0.9)
...
# 撞击声
# define sfx_impact = "audio/sfx/impact.wav"

# 骨头断裂声
# define sfx_dislocate = "audio/sfx/dislocate.wav"

# 登录音效
# define sfx_login = "audio/sfx/login.wav"
